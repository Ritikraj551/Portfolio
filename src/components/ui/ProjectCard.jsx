...
function ProjectCard({ title, description, tech, github, demo, image }) {
  return (
    <div className="flex md:max-w-sm md:mx-auto wind-border rounded-2xl border border-primary-dark md:shadow-glow backdrop-blur-lg hover:scale-[1.03] transition duration-300 p-4">
      <GlareHover
        glareColor="#ffffff"
        glareAngle={-30}
        glareSize={300}
